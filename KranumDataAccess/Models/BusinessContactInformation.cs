...
{
    public partial class BusinessContactInformation
    {
        ...
        public string IsLoginRelyfyFamily { get; set; }
        public string IsLoginCarePlan { get; set; }
        ...
        public string TwitterImgUrl { get; set; }
        public string FbImgUrl { get; set; }
        public string LinkedInImgUrl { get; set; }
        public bool? Unsubscribe { get; set; }
        public string IsRegruitProspect { get; set; }
        public string IsCareonomyProspect { get; set; }
        public string LastFbpost { get; set; }
        public string AgencySource { get; set; }
        public string MapLocation { get; set; }
        public string Tag { get; set; }
        public string IsCareJitProspect { get; set; }
        public string FbLinkStatus { get; set; }
        public string AgencyProviderType { get; set; }
        public decimal? CareonomyPoints { get; set; }
        public decimal? YaaHrpoint { get; set; }
        public bool? IsProfessionalAccountInIndeed { get; set; }
        ...
        public string IndeedProfileUrl { get; set; }
    }
}
