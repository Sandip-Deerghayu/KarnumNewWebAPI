...
{
    public partial class CareClientEarsInformation
    {
        public int Id { get; set; }
        public string CareClientUuid { get; set; }
        public string NurseUuid { get; set; }
        public string LevelOfHearingLoss { get; set; }
        public string AssstLevelForHearing { get; set; }
        public string IsCorrespondingDxforHearing { get; set; }
        public string FirstCorrespondingDiagnosis { get; set; }
        public string SecondCorrespondingDiagnosis { get; set; }
